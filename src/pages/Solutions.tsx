...
const Solutions = () => {
  ...
  const content = solutionContent[solutionType as keyof typeof solutionContent] || {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-brand-darkGray mb-2">Documentation Management</h3>
              <p className="text-brand-darkGray/70">Centralize all your important documents with version control and approval workflows.</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-brand-darkGray mb-2">Audit Readiness</h3>
              <p className="text-brand-darkGray/70">Always be prepared for inspections with real-time compliance tracking and gap analysis.</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-brand-darkGray mb-2">Real-time Analytics</h3>
              <p className="text-brand-darkGray/70">Monitor your compliance metrics across all facilities with dashboards and reports.</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <ConversionTracker action={`view_${solutionType}_solution`} />
    </div>
  );
};
