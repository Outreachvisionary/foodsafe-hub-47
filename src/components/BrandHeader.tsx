  ...
  return <div className="bg-cc-teal py-8 px-4 md:px-8 text-center">
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col items-center justify-center mb-6">
          <img alt="Compliance Core Logo" src="/lovable-uploads/515ea5ef-18c2-4017-8772-1783b71937c4.png" className="bg-teal h-10 mb-10 object-align center below header" />
