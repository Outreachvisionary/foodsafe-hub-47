  ...
  return (
    <div className="w-64 h-full border-r border-border bg-white">
      <div className="p-4 border-b border-border">
        <h2 className="font-semibold text-lg text-charcoal">Standards</h2>
      </div>
      <div className="py-2">
        <Accordion type="single" collapsible defaultValue={defaultOpenItem}>
          {standards.map((standard) => (
            <AccordionItem key={standard.id} value={standard.id} className="border-b-0">
              <AccordionTrigger className="px-4 py-3 hover:bg-secondary hover:no-underline">
                    ...
                    <Link 
                      ...
                      className={cn(
                        ...
                        currentPath === module.path 
                          ...
                          : "text-charcoal-light hover:bg-secondary hover:text-charcoal transition-colors"
                      )}
                    >
                      {module.icon}
