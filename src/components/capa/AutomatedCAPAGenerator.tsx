    ...
    const loadPotentialCAPAs = async () => {
      try {
        ...
        if (automationEnabled) {
          const data = await getPotentialCAPAs('default', 'system');
...
// Mock function for getPotentialCAPAs
async function getPotentialCAPAs(orgId: string, userId: string): Promise<any[]> {
  // In a real implementation, this would fetch from the API/database
  return [
    {
      id: '1',
      title: 'Critical Temperature Deviation',
      description: 'Temperature records show critical deviation in cold storage unit #3',
      source: 'monitoring',
      priority: 'High',
      suggestedActions: 'Investigate cold storage unit #3 for mechanical failures',
      detectionDate: new Date().toISOString(),
    },
    {
      id: '2',
      title: 'Foreign Material Detection in Line 2',
      description: 'Metal detector triggered multiple times at production line 2',
      source: 'production',
      priority: 'Critical',
      suggestedActions: 'Inspect machinery for loose parts, review maintenance records',
      detectionDate: new Date().toISOString(),
    }
  ];
}
