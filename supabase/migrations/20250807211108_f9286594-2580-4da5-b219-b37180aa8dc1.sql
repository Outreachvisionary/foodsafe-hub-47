-- Make training schema idempotent and add any missing columns
...
-- Ensure priority column exists on sessions
...
-- Policies with IF NOT EXISTS logic
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_courses' AND polname='Courses are viewable by everyone'
  ) THEN
    CREATE POLICY "Courses are viewable by everyone" ON public.training_courses FOR SELECT USING (true);
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_courses' AND polname='Users can create courses'
  ) THEN
  ...
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_courses' AND polname='Users can update their own courses'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_modules' AND polname='Modules are viewable by everyone'
  ) THEN
    CREATE POLICY "Modules are viewable by everyone" ON public.training_modules FOR SELECT USING (true);
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_modules' AND polname='Users can manage modules via parent course ownership'
  ) THEN
  ...
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_modules' AND polname='Users can update modules'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_sessions' AND polname='Sessions are viewable by everyone'
  ) THEN
    CREATE POLICY "Sessions are viewable by everyone" ON public.training_sessions FOR SELECT USING (true);
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_sessions' AND polname='Users can create sessions'
  ) THEN
  ...
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_sessions' AND polname='Users can update their own sessions'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_records' AND polname='Records are viewable by everyone'
  ) THEN
    CREATE POLICY "Records are viewable by everyone" ON public.training_records FOR SELECT USING (true);
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_records' AND polname='Users can create training records'
  ) THEN
    CREATE POLICY "Users can create training records" ON public.training_records FOR INSERT WITH CHECK (auth.uid() IS NOT NULL);
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_records' AND polname='Users can update their own records or admins'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_plans' AND polname='Plans are viewable by everyone'
  ) THEN
    CREATE POLICY "Plans are viewable by everyone" ON public.training_plans FOR SELECT USING (true);
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_plans' AND polname='Users can create plans'
  ) THEN
  ...
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_plans' AND polname='Users can update their own plans'
  ) THEN
...
DO $$ BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_materials' AND polname='Materials are viewable by everyone'
  ) THEN
    CREATE POLICY "Materials are viewable by everyone" ON public.training_materials FOR SELECT USING (true);
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_materials' AND polname='Users can create materials'
  ) THEN
  ...
  END IF;
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE schemaname='public' AND tablename='training_materials' AND polname='Users can update their own materials'
  ) THEN
