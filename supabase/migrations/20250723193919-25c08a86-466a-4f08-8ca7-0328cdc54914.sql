-- =============================================
-- STANDARDS MODULE DATABASE MIGRATION
-- =============================================

-- Create enums for standards
...
-- Update existing facility_standards table
...
CREATE TABLE IF NOT EXISTS public.standard_requirements (
  ...
  UNIQUE(standard_id, requirement_number)
);
...
-- Create audit_findings table (enhanced from existing)
...
ADD COLUMN IF NOT EXISTS finding_severity finding_severity,
...
ADD COLUMN IF NOT EXISTS finding_status finding_status DEFAULT 'Open',
