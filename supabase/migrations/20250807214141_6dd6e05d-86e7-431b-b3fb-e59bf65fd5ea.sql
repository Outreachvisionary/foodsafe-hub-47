...
-- Insert sample training records to show completion tracking
...
SELECT 
  ...
  CASE 
    ...
    WHEN ts.title = 'HACCP Implementation' THEN 'In_Progress'::training_status
...
-- Insert a sample training course
...
(
  'Food Safety Basics',
  'Introduction to food safety principles and practices',
  120,
  80.0,
  'ade0cfe2-b13a-4086-ab6c-1e8812f6b789',
  'Food_Safety'
...
(
  ...
  'Comprehensive training plan for new production employees',
  ARRAY['Production Worker', 'Food Handler'],
  ARRAY['Production'],
  'ade0cfe2-b13a-4086-ab6c-1e8812f6b789',
  true,
  'High',
